 ...
 * 目前有以下功能:
 *    支持常用的日志级别: debug/info/warn/error, 说实话其他的级别极少用到
 *    支持变量替换: 类似slf4j中的logger.info("a={}",a)这种, 其实console本身已经支持的
 *    根据日志级别设置样式: debug是黑色, info是默认, warn是黄色, error是红色, 看起来清晰很多
 *    定义每个logger的名字: 也算是常规功能了吧
 *
 * 关于变量替换, 参考:
